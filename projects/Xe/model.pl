...
%model = ( 
  ...
  'nelectrons',    54,               # number of target electrons
  ...
  'basis',         "cc-pVDZ-PP-Xe",         # make sure there are corresponding files in $dir_basis (see below)
  ...
  'nfrozen',       5,                 # number of frozen target orbitals (used for SEP and CAS)      
  ...
  'frozen_orbs',   [5,0,0,0,0,0,0,0], # which orbitals for each symmetry to use as frozen, 
  ...
  # For xenon atom, we use an active space with 8 electrons in 8 orbitals (5s and 5p)
  ],
