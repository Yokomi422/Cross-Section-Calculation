...
%model = ( 
  ...
  'nactive',       4,                 # number of active target orbitals (used for SEP and CAS)
                                      #   if -1 then all available orbitals provided by the basis are used 
  'nvirtual',      3,                 # number of virtual orbitals
  ...
  'active_orbs',   [4,0,0,0,0,0,0,0], # which orbitals for each symmetry to use as active, 
