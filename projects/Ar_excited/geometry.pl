...
%geometry = (
  ...
  'suffix', ".Ar_atom",   # string added to model directory to distinguish runs
                              # with different geometry settings

  'geometry_labels',  "   Ar atom   ",         # labels used on the first line of output files
...
#
# Argon atom geometry - single atom at origin
push(@{$geometry{'geometries'}},
     { 'description', "   Ar atom  ",
       'gnuplot_desc', "Ar atom",
