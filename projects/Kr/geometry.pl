...
%geometry = (
  ...
  'suffix', ".Kr_atom",   # string added to model directory to distinguish runs
                              # with different geometry settings

  'geometry_labels',  "   Kr atom   ",         # labels used on the first line of output files
...
#
# Krypton atom geometry - single atom at origin
push(@{$geometry{'geometries'}},
     { 'description', "   Kr atom  ",
       'gnuplot_desc', "Kr atom",
