...
%geometry = (
  ...
  'suffix', ".He_atom",   # string added to model directory to distinguish runs
                              # with different geometry settings

  'geometry_labels',  "   He atom   ",         # labels used on the first line of output files
...
#
# Helium atom geometry - single atom at origin
push(@{$geometry{'geometries'}},
     { 'description', "   He atom  ",
       'gnuplot_desc', "He atom",
