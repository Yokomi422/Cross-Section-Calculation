...
%run = (
  ...
  'parallel_geom',   2,  # number of geometries to be invoked in the same time
  'parallel_symm',   2,  # number of symmetries to be invoked in the same time (values <= 0 trigger alternative workflow using mpi-scatci)
